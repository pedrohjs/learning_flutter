...
mixin _$LoginStore on _LoginStore, Store {
  ...
  String toString() {
    final string =
        'email: ${email.toString()},password: ${password.toString()},showPassword: ${showPassword.toString()},loggedIn: ${loggedIn.toString()},loading: ${loading.toString()},isEmailValid: ${isEmailValid.toString()},isPasswordValid: ${isPasswordValid.toString()},isFormValid: ${isFormValid.toString()},loginPressed: ${loginPressed.toString()}';
    return '{$string}';
  }
}
